    ...
    return (
        <div className="max-w-6xl mx-auto px-4 py-4">
            ...
            >
                ...
                <Skeleton loading={isLoadingGetViewProfileUser} active paragraph={{ rows: 1 }}>
                        ...
                        <div className="flex items-start gap-3">
                            ...
                            <div>
                                ...
                                <Space size="small" wrap className="mt-1">
                                    <Tag color="blue" className="rounded-full !h-8 !flex !items-center">
                                        {data?.brandName ? `Thương hiệu: ${data?.brandName}` : "Không có thương hiệu"}
                                    </Tag>
                                    {data?.gender && (
                                        <Tag className="rounded-full !h-8 !flex !items-center" color={data.gender === "Male" ? "green" : "magenta"}>
                                            {data.gender}
                                        </Tag>
                                    )}
                                    {data?.country && <Tag className="rounded-full !h-8 !flex !items-center">{data.country}</Tag>}
                                </Space>
                            </div>
                        </div>
