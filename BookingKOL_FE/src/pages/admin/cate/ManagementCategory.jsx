...
import { useGetAllCategory } from "../../../hook/admin/cate/useGetAllCategory";
import { CategoryOutlined } from "@mui/icons-material";
import { useRemoveCategory } from "../../../hook/admin/cate/useRemoveCategory";
...
const ManagementCategory = () => {
    ...
    const columns = [
        ...
        },
        {
            ...
            dataIndex: "key",
            width: "20%",
            render: (key) => <Tag color="blue"><div className="!h-10 !flex !items-center">{key}</div></Tag>
        },
        {
            title: "Trạng thái",
            key: "deleted",
    ...
    return (
        <div className="relative h-full">
            ...
            <div className='flex gap-5 justify-end'>
                ...
                >
                    <Plus size={16}/>Tạo Loại Sản phẩm
                </Button>
            </div>
