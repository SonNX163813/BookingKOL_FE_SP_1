import { Form, Input, InputNumber, Button, Card, Upload, message, Row, Col, Typography } from "antd";
...
const CreateCoursePage = () => {
    ...
    const { 
        ...
        handleCreateCourse 
    } = useCreateCourse(onSuccessCreateCourse);
                ...
                <Row gutter={32}>
                    <Col xs={24} md={14}>
                        ...
                        >
                            ...
                            >
                                <InputNumber className="h-12!" style={{ width: "100%" }} min={0} max={100} placeholder="Nhập phần trăm giảm giá" />
                            </Form.Item>
                            <Form.Item
                                label="Mô tả"
                                name="description"
